// file: src/components/FeaturesSection.jsx (continued)
       ...
       >
         {features.map((feature) => (
           <motion.div
             ...
             className={`group relative bg-white rounded-3xl p-8 shadow-soft hover:shadow-large transition-all duration-500 border border-gray-100 overflow-hidden`}
           >
             ...
             <div className="relative z-10">
               ...
               <motion.div 
                 ...
                 whileHover={{ x: 5 }}
               >
                 <span className="text-primary-600 font-semibold text-sm cursor-pointer flex items-center">
